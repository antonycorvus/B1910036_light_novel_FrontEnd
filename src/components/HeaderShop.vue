  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item border border-light rounded-pill text-dark bg-light">
      ...
      <form class="d-flex flex-mb">
        <input class="form-control me-2 hiden" id="input_search" type="search" placeholder="Nhập vào đây để tìm kiếm..." aria-label="Search">
         ...
         <div class="wrapper_cart">
             <div class="cart_link" id="cart_link">
                <div class="card card-body bg-dark cart-info"> 
                    <div class="cart-list">
                        <h4 class="text-light">Danh sách truyện yêu thích</h4>
                         <router-link to="/cart" style="text-decoration: none;">
                        <div class="" v-for="item in carts">
                            <div class="item-img">
                            ...
                            <div class="item-price">
                                <span class="text-light price-product">{{item.price}} lượt xem</span>
                            </div>
                        </div>   
                         </router-link>          
                  </div>
                  <div class="footer-cart">
                          <span class="text-light">Có <span class="lenghtCart">{{getlengthcarts }}</span> truyện trong danh sách </span>
                          <button class="btn btn-success" type="button" @click="gotocart">Xem danh sách</button>
                  </div>
            </div>
          </div>
